...
makeFile('ctrl-f', ['<ctrl>'], 'f', eitherTermOrNot, '<ctrl>+f', '')
...
makeFile('ctrl-b', ['<ctrl>'], 'b', eitherTermOrNot, '<ctrl>+b', '')
...
makeFile('alt-h', ['<alt>'], 'h', eitherTermOrNot, '<alt>+h', '<left>')
makeFile('alt-j', ['<alt>'], 'j', eitherTermOrNot, '<alt>+j', '<down>')
makeFile('alt-k', ['<alt>'], 'k', eitherTermOrNot, '<alt>+k', '<up>')
makeFile('alt-l', ['<alt>'], 'l', eitherTermOrNot, '<alt>+l', '<right>')
